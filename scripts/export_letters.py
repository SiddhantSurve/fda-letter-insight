...
Run as a scheduled job (e.g. every 10 minutes):
    python scripts/export_letters.py

Output: path from LETTERS_CSV_PATH, or ./letters.csv
...
OUT_PATH = os.environ.get("LETTERS_CSV_PATH", "/tmp/fda-letters/letters.csv")
